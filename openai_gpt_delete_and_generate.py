...
os.environ['TORCH_HOME']='/zhangpai25/wyc/drg/web_data/'
os.environ['DG_TRAIN_DATA'] = '/zhangpai25/wyc/drg/drg_data/hlm/processed_files_with_bert_with_best_head/sentiment_train_0.txt'
os.environ['DG_EVAL_DATA'] = '/zhangpai25/wyc/drg/drg_data/hlm/processed_files_with_bert_with_best_head/sentiment_dev_0.txt'
os.environ['DG_MODEL_OUT'] = '/zhangpai25/wyc/drg/model_saved/dg_2hlm'
...
def main():
    ...
    # tokenizer = OpenAIGPTTokenizer.from_pretrained('/zhangpai25/wyc/drg/generated_gpt_data/', special_tokens=special_tokens)
    ...
    print('start token id:{}'.format(start_token_id))
    print("eval Example = {} and check_info: {} ".format(eval_dataset[0], start_token_id in eval_dataset[0]))
    time.sleep(2)
